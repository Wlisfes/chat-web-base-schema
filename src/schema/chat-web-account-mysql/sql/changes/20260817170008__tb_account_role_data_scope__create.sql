CREATE TABLE IF NOT EXISTS `tb_account_role_data_scope` (
    ...
    `uid` varchar(19) NOT NULL COMMENT '数据范围规则UID',
    ...
    PRIMARY KEY (`key_id`),
    UNIQUE KEY `uk_tb_account_role_data_scope_uid` (`uid`),
    UNIQUE KEY `uk_tb_account_role_data_scope_resource` (`role_uid`, `resource_code`),
